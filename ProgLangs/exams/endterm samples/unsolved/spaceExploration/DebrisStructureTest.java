...
public class DebrisStructureTest {
    @BeforeAll
    public static void init() {
        CheckThat.theClass("spaceexploration.model.Debris", withParent("spaceexploration.model.Resource"))
    ...
    public void methodSetStable04() {
        it.implementsMethod("setStable");
    }
